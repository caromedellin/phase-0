...
// • Introduction (Enlaces a un sitio externo.)
...
// In JS it's possible to declare a variable with the value undefined and it wll still run it it is different than defining  an empty variable.
...
// • Ch. 3: Functions (Enlaces a un sitio externo.)
...
// A function declaration is similar to a method, it's a longer syntax than ruby's methods and more excel like. It remainds me of a mathematical function. Functions also have their own scopes. 
...
// the index number also start as zero, just ike do in Ruby maily because this is a long tradition in tech, and it’s followed regularly. 
...
//   Although I have seen some videos about using the ruby hashes to refactor methods and that completely blew my mind! I guess that is similar to this, but I will not get in depth with those options.
