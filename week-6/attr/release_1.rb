...
• What are these methods doing?
  • The class Profile creates new objects with the following default variables
  ...
  It also assigns it some instance methods, the what_age and their like are our own made readers
  And the variables can be changed from the default using the change_my_age/name/ocupation
  Then it creates an instance of the class and prints it
  Afterwards it used the change methods to change the default values and prints the new tailored info
• How are they modifying or returning the value of instance variables?
  • With the readers 
  • Def name
    ○ @name
  • end
• Then the instance variables are modified with the instance methods inside the class
The coolest part is the sleep so te computer doesn't do everything at once, and you can sort of see it in a bit of an animated way in the terminal, loved that part about this program
=end